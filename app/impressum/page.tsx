    ...
    <main className="min-h-screen bg-[#11100e] px-5 py-16 text-[#f5f2ec] sm:px-8 sm:py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-12 space-y-10 text-sm leading-7 text-white/65 sm:text-base">
          <section>
            <h2 className="font-serif text-2xl text-[#f5f2ec]">
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#f5f2ec]">Contact</h2>
            <p className="mt-4">
              Email:{" "}
              <a
                href="mailto:andreas.turowski1966@gmail.com"
                className="text-[#c78a3a] underline decoration-[#c78a3a]/35 underline-offset-4 transition-colors hover:text-[#dca45c]"
              >
