...
const copy = {
  en: {
    ...
    sections: [
      ...
      ["5. Embedded Spotify and YouTube Content", "Spotify and YouTube content is blocked by default. A connection to Spotify is established only after you select “Load Spotify”; a connection to YouTube through the privacy-enhanced youtube-nocookie.com domain is established only after you select “Load YouTube.” The providers may then receive your IP address, device and browser data, and information about content use. The legal basis is your consent under Article 6(1)(a) GDPR and Section 25(1) TDDDG. Consent applies only to the current page view."],
      ["6. External Links", "This website links to Spotify, Amazon Music, and YouTube. Merely displaying those links does not connect you to the providers. When you select a link, you leave our website and the privacy policy of the relevant provider applies."],
      ["7. Analytics and Marketing", "We do not use our own analytics or marketing services. Spotify and YouTube content is not loaded without your permission."],
  ...
  de: {
    ...
    sections: [
      ...
      ["5. Spotify- und YouTube-Einbettungen", "Spotify- und YouTube-Inhalte sind zunächst blockiert. Erst nach Auswahl von „Spotify laden“ wird eine Verbindung zu Spotify hergestellt; eine Verbindung zu YouTube über die datenschutzfreundlichere Domain youtube-nocookie.com entsteht erst nach Auswahl von „YouTube laden“. Dabei können IP-Adresse, Geräte- und Browserdaten sowie Angaben zur Nutzung übermittelt werden. Rechtsgrundlage ist Ihre Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG. Sie gilt nur für den aktuellen Seitenaufruf."],
      ["6. Externe Links", "Diese Website verlinkt zu Spotify, Amazon Music und YouTube. Durch die bloße Anzeige der Links wird keine Verbindung hergestellt. Erst beim Anklicken verlassen Sie unsere Website; anschließend gilt die Datenschutzerklärung des jeweiligen Anbieters."],
      ["7. Analyse und Marketing", "Wir verwenden keine eigenen Analyse- oder Marketingdienste. Spotify- und YouTube-Inhalte werden ohne Ihre Freigabe nicht geladen."],
  ...
  fr: {
    ...
    sections: [
      ...
      ["5. Contenus Spotify et YouTube intégrés", "Les contenus Spotify et YouTube sont bloqués par défaut. Une connexion à Spotify n’est établie qu’après avoir sélectionné « Charger Spotify » ; une connexion à YouTube via le domaine youtube-nocookie.com n’est établie qu’après avoir sélectionné « Charger YouTube ». Les fournisseurs peuvent alors recevoir votre adresse IP, des données sur votre appareil et votre navigateur ainsi que des informations sur l’utilisation du contenu. Le traitement repose sur votre consentement conformément à l’article 6, paragraphe 1, point a), du RGPD et à l’article 25, paragraphe 1, de la TDDDG. Il ne vaut que pour la consultation en cours."],
      ["6. Liens externes", "Ce site contient des liens vers Spotify, Amazon Music et YouTube. Leur simple affichage n’établit aucune connexion avec ces fournisseurs. Lorsque vous cliquez sur un lien, vous quittez notre site et la politique de confidentialité du fournisseur concerné s’applique."],
      ["7. Analyse et marketing", "Nous n’utilisons aucun service d’analyse ou de marketing. Les contenus Spotify et YouTube ne sont pas chargés sans votre autorisation."],
  ...
  es: {
    ...
    sections: [
      ...
      ["5. Contenido integrado de Spotify y YouTube", "El contenido de Spotify y YouTube está bloqueado de forma predeterminada. La conexión con Spotify solo se establece después de seleccionar «Cargar Spotify»; la conexión con YouTube a través del dominio youtube-nocookie.com solo se establece después de seleccionar «Cargar YouTube». Los proveedores pueden recibir entonces tu dirección IP, datos del dispositivo y del navegador e información sobre el uso del contenido. La base jurídica es tu consentimiento conforme al artículo 6, apartado 1, letra a), del RGPD y al artículo 25, apartado 1, de la TDDDG. Solo se aplica a la visita actual."],
      ["6. Enlaces externos", "Este sitio enlaza con Spotify, Amazon Music y YouTube. La mera visualización de los enlaces no establece ninguna conexión con estos proveedores. Al hacer clic abandonas nuestro sitio y pasa a aplicarse la política de privacidad del proveedor correspondiente."],
      ["7. Analítica y marketing", "No utilizamos servicios propios de analítica ni de marketing. El contenido de Spotify y YouTube no se carga sin tu autorización."],
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-12 space-y-12 text-sm leading-7 text-white/65 sm:text-base">
          ...
          <p>
            ...
            <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className={linkClass}>Google/YouTube Privacy Policy</a>{" · "}
