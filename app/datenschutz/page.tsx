...
const linkClass =
  "text-[#c78a3a] underline decoration-[#c78a3a]/35 underline-offset-4 transition-colors hover:text-[#dca45c]";
  ...
  return (
    <main className="min-h-screen bg-[#11100e] px-5 py-16 text-[#f5f2ec] sm:px-8 sm:py-24">
      <div className="mx-auto max-w-3xl">
        <Link
          href="/"
          className="text-[0.65rem] font-bold uppercase tracking-[0.24em] text-[#c78a3a] transition-colors hover:text-[#dca45c]"
        >
          ← Back home
        </Link>
        <header className="mt-12 border-b border-white/10 pb-10">
          <p className="text-[0.65rem] font-bold uppercase tracking-[0.3em] text-[#c78a3a]">
            Privacy
          </p>
        ...
        <div className="mt-12 space-y-12 text-sm leading-7 text-white/65 sm:text-base">
          ...
          <section className={sectionClass}>
            ...
            <p>
              This website links to Spotify and Amazon Music. Merely viewing
              our website does not establish a connection to these services
              through those links. When you select a link, you leave our
              website. From that point onward, the relevant provider processes
          ...
          <section className={sectionClass}>
            <h2 className={headingClass}>6. Cookies and Analytics</h2>
            <p>
              ...
              stored permanently. Spotify content will not be loaded without
              your consent.
            </p>
          </section>
          ...
          <section className={sectionClass}>
            ...
            <p>
              ...
              Kavalleriestraße 2–4, 40213 Düsseldorf, Germany. Further
              information and the complaint form are available at{" "}
              <a
